...
organizations:
  - name: School of Electrical and Computer
  - name : University of Oklahoma
    url: https://www.ou.edu/coe/ece

# Social network links
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'mailto:qili@ou.edu'
    label: E-mail Me
  - icon: brands/github
    url: https://github.com/liqi216
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/qili0216/
